      ...
      <div className="w-full max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-bold text-foreground">
              Iftekharul <span className="text-[#FFD028]">Alam</span>
            </h3>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                <svg className="w-5 h-5 text-[#FFD028]" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between pt-8 border-t border-border">
          <div className="flex items-center gap-6 mb-4 md:mb-0">
            <a 
              href="https://www.facebook.com/share/17sqVq4hdi/" 
              target="_blank" 
            ...
            <a 
              href="https://www.instagram.com/knoxneon/" 
              target="_blank" 
              rel="noopener noreferrer"
            ...
            <a 
              href="https://github.com/KnoxNeon" 
              target="_blank" 
              rel="noopener noreferrer"
              className="text-muted-foreground hover:text-[#333] dark:hover:text-white transition-colors"
              aria-label="GitHub"
            >
              <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="text-center md:text-right">
            <p className="text-muted-foreground text-sm">
              © {currentYear} Iftekharul Alam. All rights reserved.
            </p>
